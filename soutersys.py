...
class Souter(QtWidgets.QMainWindow):
    ...
    def crearnota(self):
        ...
        if self.ui.cntbtt==1:
            ...
            self.ui.Crearnota(28,'D5') 
            self.ui.Crearnota(28,'B5') 
            self.ui.Crearnota(32,'KK') 
            self.ui.Crearnota(4,'KK') 
            self.ui.Crearnota(2,'KK') 
            self.ui.Crearnota(2,'C#5') 
            self.ui.Crearnota(2,'D5') 
            self.ui.Crearnota(8,'C5') 
            self.ui.Crearnota(8,'B#4') 
            self.ui.Crearnota(8,'A#4')
            self.ui.Crearnota(8,'G4') 
            self.ui.Crearnota(8,'F#4') 
            self.ui.Crearnota(8,'E4')         
